...
<form method="post" action="../php/dateimp.php">
<center>
...
<input class="form-control" type="datetime-local" required="" name="date1" >

</div>

<div class="form-group">
<span class="form-label">Date dE SORTIE</span>
<input class="form-control" type="datetime-local" required="" name="date2" min='<?php echo date("Y-m-d"); echo "T".time() ;//d="23-4-2021";//new DateTime("now"); ?>'>
</div>
</div>
