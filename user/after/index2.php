      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
        <div class="blog_box">
          ...
          <h3>Veuiller selectionner un parking:</h3>
          <form  class="main_form" method="post" action="index3.php">
          <div class="custom-select" style="width:217px;height:45px;">
            <select name="p_code" >
                <option value="0">none</option>
              <?php
          require_once("../php/parkingselect.php");
          ?>
          </select>
</div>
...
<br>
        ...
        <br/><br/><br/><br/>
          ...
          <a class="button active" href="index.php"><input class="button_user" type="button" value="annuler" ></a>
