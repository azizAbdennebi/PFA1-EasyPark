                    ...
                    <div class="full">
                        <div class="right_header_info">
                            <ul>
                                ...
                                <li class="button_user"><a class="button active" href="index.html">Home</a><a class="button" href="register.php">S'abonner</a></li>
    ...
    <fooetr>
        <div class="footer">
            <div class="container-fluid">
                <div class="row">
                  <div class=" col-md-12">
                    <h2><strong class="white"> Se connecter</strong></h2>
                  </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      
                        <form class="main_form" method="post" action="php/processlogin.php">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input class="send" type="submit" id="btn" value="se connecter">
                                    <center>
                                    <h4>     
                                        <?php
